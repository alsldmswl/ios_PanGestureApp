...
//            if self.frame.minY < 40 {
//                self.frame.origin.y = 0
//            }
//            if let hasSuperView2 = self.superview {
//                if self.frame.maxY > hasSuperView2.frame.maxY {
//                    self.frame.origin.y = hasSuperView2.frame.maxY - self.bounds.height
//                }
//            }
